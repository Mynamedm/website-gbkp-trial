                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center mb-16 last:mb-0">
                    ...
                    <div class="{{ $isEven ? '' : 'order-1 lg:order-2' }}">
                        ...
                        <div class="flex items-center gap-3 mt-5">
                            <a href="{{ route('client.kategorial-detail', $item['slug']) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-700 text-white text-[13px] font-semibold rounded-lg hover:bg-blue-800 transition-colors shadow-sm">
                                Lihat Selengkapnya
