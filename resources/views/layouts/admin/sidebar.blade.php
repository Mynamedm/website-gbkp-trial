    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        @php
            $navItems = [
                ...
                ['label' => 'Jadwal Ibadah', 'route' => 'admin.schedules.index', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/>'],
            ...
            // Hanya super_admin yang bisa manage users
            if(auth()->user()->hasRole('super_admin')) {
